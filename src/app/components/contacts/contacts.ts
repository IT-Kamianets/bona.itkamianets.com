...
export class Contacts {
  ...
  socials = [
    ...
    {
      label: 'Instagram', url: 'https://www.instagram.com/bonarest.ua?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
    ...
    {
      label: 'TikTok', url: 'https://www.tiktok.com/@bona.restaurant?is_from_webapp=1&sender_device=pc',
    ...
    {
      label: 'YouTube', url: 'https://youtube.com/@bonaukraine?si=pP6Kts-YmCKsFGbK',
